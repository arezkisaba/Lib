...
{
    public class PlaceSimpleBetsResponse
    {
        ...
        public class Betleg
        {
            ...
            public string cmsSportName { get; set; }
            public int cmsSportId { get; set; }
    ...
    public class PlaceSimpleBetsResponseError
    {
        public string beterror { get; set; }
    }

    public class PlaceSimpleBetsResponseLoginError
    {
